...
public class MilvusVectorStoreCustomFieldNamesIT {
	...
	public void searchWithCustomFieldNames(String metricType) {
		...
		contextRunner.withPropertyValues("test.spring.ai.vectorstore.milvus.metricType=" + metricType,
				...
				"test.spring.ai.vectorstore.milvus.metadataFieldName=meta").run(context -> {
			...
			List<Document> fullResult = vectorStore
					.similaritySearch(SearchRequest.query("Spring"));
	...
	public static class TestApplication {
		...
		@Value("${test.spring.ai.vectorstore.milvus.metadataFieldName}")
