 ...
 * functionality via A2A protocol endpoints. It extends {@link A2AAgent} to provide agent
 ...
 * <li>Request routing to {@link io.a2a.server.agentexecution.AgentExecutor}</li>
 ...
 */
public interface A2AAgentServer extends A2AAgent {
	 ...
	 */
	Map<String, Object> handleJsonRpcRequest(Map<String, Object> requestBody);
