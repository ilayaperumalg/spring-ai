...
│ SimpleAgentExecutor                                                     │
│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │
│ • Abstract base class implementing AgentExecutorLifecycle               │
│ • Handles full task lifecycle management                               │
│ • Provides SynchronousEventQueue for blocking execution                │
│ • Developers extend and implement onExecute() only                     │
│                                                                         │
│ Example:                                                                │
│   public class WeatherAgentExecutor extends SimpleAgentExecutor {      │
│     @Override                                                           │
...
│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │
│ • Extends SimpleAgentExecutor with ChatClient integration              │
...
│                                                                         │
│ Example:                                                                │
│   public class TestAgent extends SpringAIAgentExecutor {               │
│     @Override                                                           │
...
### 2. SimpleAgentExecutor Pattern

Extend `SimpleAgentExecutor` to implement custom agent logic:
...
|--------|------------------|-------------------|
| **Base Classes** | `SimpleAgentExecutor`, `SpringAIAgentExecutor` | Direct `AgentExecutor` implementation |
| **Agent Interface** | Unified `A2AAgent` for local and remote | Separate client and server abstractions |
